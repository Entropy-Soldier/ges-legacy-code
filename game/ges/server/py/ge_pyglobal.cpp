...
BOOST_PYTHON_MODULE(GEGlobal)
{
	...
	enum_< GES_EVENTHOOK >("EventHooks")
        ...
        .value("GP_PLAYERFINISHDISCONNECT",	FUNC_GP_PLAYERFINISHDISCONNECT)
		...
		.value("GP_ITEMTRACKED",		    FUNC_GP_ITEMTRACKED)
		.value("GP_ITEMUNTRACKED",		    FUNC_GP_ITEMUNTRACKED)
        .value("GP_CVARCHANGED",            FUNC_GP_CVARCHANGED)
	...
	enum_< CGETokenManager::LocationFlag  >("LocationFlag")
		...
		.value("SPAWN_ARMOR",		CGETokenManager::LOC_ARMOR)
	...
	enum_< GES_WEAPONS >("Weapons")
        ...
        .value("WEAPON_WATCHLASER", WEAPON_WATCHLASER)
    ...
    self.attr("ET_START_ITEMSPAWNED") = ET_START_ITEMSPAWNED;
	self.attr("ET_START_ITEMDROPPED") = ET_START_ITEMDROPPED;
