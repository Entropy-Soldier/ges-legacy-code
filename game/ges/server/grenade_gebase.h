...
public:
	...
	virtual void	    SetLifetimeMult( float lifetimeMult ) { m_flLifetimeMult = lifetimeMult; }
	virtual float	    GetLifetimeMult() { return m_flLifetimeMult; }
