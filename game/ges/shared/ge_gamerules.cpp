...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		...
		def.AddAmmoTypeGE( AMMO_9MM,			DMG_BULLET,	TRACER_LINE_AND_WHIZ,	AMMO_9MM_MAX,			BULLET_IMPULSE(115, 1100),	AMMO_9MM_CRATE,				AMMO_9MM_ICON,			PICKUP_SOUND_9MM,			CRATE_SKIN_9MM	 );
		def.AddAmmoTypeGE( AMMO_GOLDENGUN,		DMG_BULLET,	TRACER_LINE_AND_WHIZ,	AMMO_GOLDENGUN_MAX,		BULLET_IMPULSE(170, 1700),	AMMO_GOLDENGUN_CRATE,		AMMO_GOLDENGUN_ICON,	PICKUP_SOUND_GOLDENGUN,		CRATE_SKIN_GOLDENGUN );
		def.AddAmmoTypeGE( AMMO_MAGNUM,			DMG_BULLET,	TRACER_LINE_AND_WHIZ,	AMMO_MAGNUM_MAX,		BULLET_IMPULSE(150, 1500),	AMMO_MAGNUM_CRATE,			AMMO_MAGNUM_ICON,		PICKUP_SOUND_MAGNUM,		CRATE_SKIN_MAGNUM );
		def.AddAmmoTypeGE( AMMO_RIFLE,			DMG_BULLET,	TRACER_LINE_AND_WHIZ,	AMMO_RIFLE_MAX,			BULLET_IMPULSE(130, 2000),	AMMO_RIFLE_CRATE,			AMMO_RIFLE_ICON,		PICKUP_SOUND_RIFLE,			CRATE_SKIN_RIFLE );
		def.AddAmmoTypeGE( AMMO_BUCKSHOT,		DMG_BULLET,	TRACER_LINE_AND_WHIZ,	AMMO_BUCKSHOT_MAX,		BULLET_IMPULSE(54, 1225),	AMMO_BUCKSHOT_CRATE,		AMMO_BUCKSHOT_ICON,		PICKUP_SOUND_BUCKSHOT,		CRATE_SKIN_BUCKSHOT);
		def.AddAmmoTypeGE( AMMO_REMOTEMINE,		DMG_BLAST,	TRACER_NONE,			AMMO_REMOTEMINE_MAX,	50,							AMMO_REMOTEMINE_CRATE,		AMMO_REMOTEMINE_ICON,	PICKUP_SOUND_REMOTEMINE,	CRATE_SKIN_REMOTEMINE );
		def.AddAmmoTypeGE( AMMO_PROXIMITYMINE,	DMG_BLAST,	TRACER_NONE,			AMMO_PROXIMITYMINE_MAX,	50,							AMMO_PROXIMITYMINE_CRATE,	AMMO_PROXIMITYMINE_ICON,PICKUP_SOUND_PROXIMITYMINE,	CRATE_SKIN_PROXIMITYMINE );
		def.AddAmmoTypeGE( AMMO_TIMEDMINE,		DMG_BLAST,	TRACER_NONE,			AMMO_TIMEDMINE_MAX,		50,							AMMO_TIMEDMINE_CRATE,		AMMO_TIMEDMINE_ICON,	PICKUP_SOUND_TIMEDMINE,		CRATE_SKIN_TIMEDMINE );
		def.AddAmmoTypeGE( AMMO_GRENADE,		DMG_BLAST,	TRACER_NONE,			AMMO_GRENADE_MAX,		50, 						AMMO_GRENADE_CRATE,			AMMO_GRENADE_ICON,		PICKUP_SOUND_GRENADE,		CRATE_SKIN_GRENADE );
		def.AddAmmoTypeGE( AMMO_TKNIFE,			DMG_SLASH,	TRACER_NONE,			AMMO_TKNIFE_MAX,		50, 						AMMO_TKNIFE_CRATE,			AMMO_TKNIFE_ICON,		PICKUP_SOUND_TKNIFE,		CRATE_SKIN_TKNIFE );
		def.AddAmmoTypeGE( AMMO_SHELL,			DMG_BLAST,	TRACER_NONE,			AMMO_SHELL_MAX,			50, 						AMMO_SHELL_CRATE,			AMMO_SHELL_ICON,		PICKUP_SOUND_SHELL,			CRATE_SKIN_SHELL );
		def.AddAmmoTypeGE( AMMO_ROCKET,			DMG_BLAST,	TRACER_NONE,			AMMO_ROCKET_MAX,		50, 						AMMO_ROCKET_CRATE,			AMMO_ROCKET_ICON,		PICKUP_SOUND_ROCKET,		CRATE_SKIN_ROCKET );
		def.AddAmmoTypeGE( AMMO_MOONRAKER,		DMG_BULLET,	TRACER_LINE_AND_WHIZ,	AMMO_MOONRAKER_MAX,		BULLET_IMPULSE(130, 2600),	AMMO_MOONRAKER_CRATE,		AMMO_MOONRAKER_ICON,	PICKUP_SOUND_MOONRAKER,		CRATE_SKIN_MOONRAKER );
		def.AddAmmoTypeGE( AMMO_WATCHLASER,		DMG_BULLET, TRACER_LINE_AND_WHIZ,	AMMO_WATCHLASER_MAX,	BULLET_IMPULSE(130, 2600),  AMMO_WATCHLASER_CRATE,		AMMO_WATCHLASER_ICON,	PICKUP_SOUND_WATCHLASER,	CRATE_SKIN_WATCHLASER );
	}
