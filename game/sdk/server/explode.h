...
void ExplosionCreate(const Vector &center, const QAngle &angles,
	...
	float flExplosionForce = 0.0f, float flExplosionForceMult = 1.0f, float flLifetimeMult = 1.0f, CBaseEntity *pInflictor = NULL, int iCustomDamageType = -1, const EHANDLE *ignoredEntity = NULL, Class_T ignoredClass = CLASS_NONE);
